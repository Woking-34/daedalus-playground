...
void Init()
{
    std::string filePath0 = "SimpleVertex.glsl";
    bool fileFound0 = findFullPath("data/fog/", filePath0);

    std::string filePath1 = "SpotLight.glsl";
    bool fileFound1 = findFullPath("data/fog/", filePath1);

    std::string filePath2 = "PointLight.glsl";
    bool fileFound2 = findFullPath("data/fog/", filePath2);

	g_staticPrograms[kLightSpot] = CompileProgramFromFile(filePath0.c_str(), filePath1.c_str());
	g_staticPrograms[kLightPoint]= CompileProgramFromFile(filePath0.c_str(), filePath2.c_str());
